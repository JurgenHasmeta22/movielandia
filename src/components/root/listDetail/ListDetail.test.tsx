...
describe("ListDetail", () => {
	...
	it("renders null when data is empty", () => {
		const { container } = renderWithTheme(
			<ListDetail data={[]} type="movie" roleData="related" />,
		);
	...
	it("renders movie list correctly", () => {
		...
		renderWithTheme(
			<ListDetail data={movieData} type="movie" roleData="related" />,
		);
	...
	it("renders serie list correctly", () => {
		...
		renderWithTheme(
			<ListDetail data={serieData} type="serie" roleData="related" />,
		);
	...
	it("renders season list correctly", () => {
		...
		renderWithTheme(
			<ListDetail data={seasonData} type="season" roleData="related" />,
		);
	...
	it("renders episode list correctly", () => {
		...
		renderWithTheme(
			<ListDetail data={episodeData} type="episode" roleData="related" />,
		);
		...
		const actorData = [
			...
			},
			{
				actor: {
					id: 2,
					fullname: "Actor 2",
					photoSrcProd: "/image2.jpg",
				},
			},
		];

		renderWithTheme(
			<ListDetail data={actorData} type="actor" roleData="cast" />,
		);
	...
	it("renders actor list correctly with Movies roleData", () => {
		...
		renderWithTheme(
			<ListDetail data={actorMovieData} type="actor" roleData="Movies" />,
		);
	...
	it("renders crew list correctly with production roleData", () => {
		...
		renderWithTheme(
			<ListDetail data={crewData} type="crew" roleData="production" />,
		);
	...
	it("renders crew list correctly with Movies roleData", () => {
		...
		renderWithTheme(
			<ListDetail data={crewMovieData} type="crew" roleData="Movies" />,
		);
