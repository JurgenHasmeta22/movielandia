...
// #region "Add Downvote"
export async function addDownvoteMovieReview({
	userId,
	movieId,
	movieReviewId,
}: VoteMovieReviewParams): Promise<any> {
	try {
		const existingDownvoteMovieReview =
			await prisma.downvoteMovieReview.findFirst({
				where: {
...
export async function addDownvoteSerieReview({
	userId,
	serieId,
	serieReviewId,
}: VoteSerieReviewParams): Promise<any> {
	try {
		const existingDownvoteSerieReview =
...
export async function addDownvoteSeasonReview({
	...
	try {
		const existingDownvoteSeasonReview =
			await prisma.downvoteSeasonReview.findFirst({
				where: {
...
export async function addDownvoteEpisodeReview({
	...
	try {
		const existingDownvoteEpisodeReview =
			await prisma.downvoteEpisodeReview.findFirst({
				where: {
...
export async function addDownvoteActorReview({
	userId,
	actorId,
	actorReviewId,
}: VoteActorReviewParams): Promise<any> {
	try {
		const existingDownvoteActorReview =
			await prisma.downvoteActorReview.findFirst({
				where: {
...
export async function addDownvoteCrewReview({
	userId,
	crewId,
	crewReviewId,
}: VoteCrewReviewParams): Promise<any> {
	try {
		const existingDownvoteCrewReview =
			await prisma.downvoteCrewReview.findFirst({
				where: {
...
export async function removeDownvoteCrewReview({
	userId,
	crewId,
	crewReviewId,
}: VoteCrewReviewParams): Promise<any> {
