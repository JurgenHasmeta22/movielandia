		...
		>
			...
			>
				<Box
					...
					onClick={() =>
						router.push(
							`/users/${review.user.id}/${review.user.userName}`,
						)
					}
				>
			...
			<Box sx={{ display: "flex", justifyContent: "center", gap: 4 }}>
				<Box sx={{ display: "flex", alignItems: "center" }}>
					...
					>
						<Tooltip
							title={
								session?.user ? "Upvote" : "Sign in to upvote"
							}
						>
							<IconButton
								disabled={
					...
					<Button
						...
						onClick={() =>
							router.push(
								`${pathname}/reviews/${review.id}/upvotes`,
							)
						}
						sx={{
							minWidth: "auto",
				...
				<Box sx={{ display: "flex", alignItems: "center" }}>
					<motion.div
						whileTap={{ scale: 0.95 }}
						animate={
							isClickedDownvote ? { scale: [1, 1.2, 1] } : {}
						}
					>
						<Tooltip
							title={
					...
					<Button
						...
						onClick={() =>
							router.push(
								`${pathname}/reviews/${review.id}/downvotes`,
							)
						}
						sx={{
							minWidth: "auto",
