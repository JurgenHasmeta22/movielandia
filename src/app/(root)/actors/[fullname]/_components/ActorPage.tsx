...
// export default function ActorPage({ searchParamsValues, actor, latestActors, relatedActors, pageCount }: any) {
...
//         try {
//             if (isAlreadyUpvoted) {
//                 await removeUpvoteActorReview({ userId: session?.user?.id, actorId: actor?.id, actorReviewId });
//             } else {
//                 await removeDownvoteActorReview({ userId: session?.user?.id, actorId: actor?.id, actorReviewId });
//                 await addUpvoteActorReview({ userId: session?.user?.id, actorId: actor?.id, actorReviewId });
//             }
//         } catch (error) {
//             showToast("error", "An error occurred while adding the upvote to actor review.");
//         }
//     }
...
//             } else {
//                 await removeUpvoteActorReview({ userId: session?.user?.id, actorId: actor?.id, actorReviewId });
//                 await addDownvoteActorReview({ userId: session?.user?.id, actorId: actor?.id, actorReviewId });
//             }
//         } catch (error) {
//             showToast("error", "An error occurred while adding the downvoted to actor review.");
//         }
//     }
//     // #endregion
...
//                 )}
//             </Box>
//             <ListDetail data={latestActors!} type="actor" roleData={"latest"} />
//             <ListDetail data={relatedActors!} type="actor" roleData="related" />
//         </Stack>
//     );
// }
