...
export default async function SeasonPage(props: ISeasonProps) {
	...
	const reviewsPage = searchParams?.reviewsPage
		? Number(searchParams.reviewsPage)
		: 1;
	const episodesPage = searchParams?.episodesPage
		? Number(searchParams.episodesPage)
		: 1;
	const relatedPage = searchParams?.relatedPage
		? Number(searchParams.relatedPage)
		: 1;
	...
	const { seasons: relatedSeasons, count: totalRelated } =
		await getRelatedSeasons(Number(seasonId), Number(serieId), relatedPage);
