/*
  ...
  - You are about to drop the column `photoSrcProd` on the `Movie` table. All the data in the column will be lost.
  - You are about to drop the column `photoSrcProd` on the `Serie` table. All the data in the column will be lost.
