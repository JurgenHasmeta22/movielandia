...
import { Box, Container, Typography, Breadcrumbs, Link as MuiLink, Paper, TextField, FormControl, InputLabel, Select, MenuItem, Button, Alert } from "@mui/material";
...
export default function CreateTopicPageContent({ categories, initialCategoryId, session }: ICreateTopicPageContentProps) {
