	...
	async function onUpvoteCrew(
		...
		try {
			...
			if (error instanceof Error) {
				...
				showToast(
					"error",
					"An unexpected error occurred while upvoting the crew.",
				);
			}
		}
	}

	async function onDownVoteCrew(
		crewReviewId: number,
		...
		try {
			...
			if (error instanceof Error) {
				...
				showToast(
					"error",
					"An unexpected error occurred while downvoting the crew.",
				);
			}
		}
	}
