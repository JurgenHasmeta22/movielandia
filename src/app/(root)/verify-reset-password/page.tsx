...
export default async function VerifyResetPasswordPage(props: {
	...
	try {
		...
		message =
			"Your email has been successfully verified. Now you can change the password.";
	} catch (error: any) {
		isError = true;
		message =
			error.message || "Verification failed. Go back and check the email";
	}

	return (
		<VerificationLayout
			title={isError ? "Verification Failed" : "Verification Successful"}
		>
