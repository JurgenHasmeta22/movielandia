    ...
    default: (props: any) => {
        ...
        return (
            <div data-testid="search-autocomplete-mock">
                <div
                    data-testid="search-autocomplete-props"
                ...
                />
                <button data-testid="filter-change-btn" onClick={() => onFilterChange("movies")}>
                    Change Filter
                </button>
                <button data-testid="show-more-btn" onClick={onShowMore}>
                    Show More
                </button>
                <button data-testid="close-btn" onClick={onClose}>
                    Close
                </button>
                <button data-testid="result-click-btn" onClick={onResultClick}>
                    Result Click
                </button>
            </div>
        );
...
describe("SearchField Component", () => {
    ...
    it("handles input changes", async () => {
        ...
        const autocompleteProps = JSON.parse(
            screen.getByTestId("search-autocomplete-props").getAttribute("data-props") || "{}",
        );
