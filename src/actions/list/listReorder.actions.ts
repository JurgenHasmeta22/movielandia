...
export async function reorderListItems({ listId, userId, type, items }: ReorderItemsParams) {
    try {
        ...
        throw new Error(error instanceof Error ? error.message : "Failed to reorder list items");
    }
}
