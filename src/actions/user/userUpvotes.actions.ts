...
// #region "Add Upvote"
export async function addUpvoteMovieReview({
	userId,
	movieId,
	movieReviewId,
}: VoteMovieReviewParams): Promise<any> {
	try {
		const existingUpvoteMovieReview =
...
export async function addUpvoteSerieReview({
	userId,
	serieId,
	serieReviewId,
}: VoteSerieReviewParams): Promise<any> {
	try {
		const existingUpvoteSerieReview =
			await prisma.upvoteSerieReview.findFirst({
				where: {
...
export async function addUpvoteSeasonReview({
	...
	try {
		const existingUpvoteSeasonReview =
...
export async function addUpvoteEpisodeReview({
	...
	try {
		const existingUpvoteEpisodeReview =
...
export async function addUpvoteActorReview({
	userId,
	actorId,
	actorReviewId,
}: VoteActorReviewParams): Promise<any> {
	try {
		const existingUpvoteActorReview =
...
export async function addUpvoteCrewReview({
	userId,
	crewId,
	crewReviewId,
}: VoteCrewReviewParams): Promise<any> {
	try {
		const existingUpvoteCrewReview =
...
export async function removeUpvoteMovieReview({
	userId,
	movieId,
	movieReviewId,
}: VoteMovieReviewParams): Promise<any> {
...
export async function removeUpvoteSerieReview({
	userId,
	serieId,
	serieReviewId,
}: VoteSerieReviewParams): Promise<any> {
...
export async function removeUpvoteActorReview({
	userId,
	actorId,
	actorReviewId,
}: VoteActorReviewParams): Promise<any> {
...
export async function removeUpvoteCrewReview({
	userId,
	crewId,
	crewReviewId,
}: VoteCrewReviewParams): Promise<any> {
