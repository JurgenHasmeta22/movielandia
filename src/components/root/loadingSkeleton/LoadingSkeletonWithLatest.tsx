            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        />
                        <Skeleton variant="text" sx={{ width: 120, height: 24, mt: { xs: 2, sm: 0 }, ml: { sm: 1 } }} />
                    </Box>
                    <Box>
                        <Skeleton variant="rectangular" sx={{ width: 150, height: 40, borderRadius: 1 }} />
                    </Box>
                </Box>
                ...
                >
                    ...
                    <Box sx={{ display: "flex", justifyContent: "center", mb: 4 }}>
                        <Skeleton variant="rectangular" sx={{ width: 300, height: 40, borderRadius: 1 }} />
                    </Box>
                </Box>
            </Box>
