        ...
        {topics.items.map((topic) => (
          ...
          >
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Started by{" "}
                <Link href={`/users/${topic.user.id}/${topic.user.userName}`} style={{ textDecoration: "none", color: theme.vars.palette.primary.main }}>
                  {topic.user.userName}
                </Link>
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mt: 2 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Last activity: {formatDistanceToNow(new Date(topic.lastPostAt), { addSuffix: true })}
              </Typography>
            </Box>
          </Paper>
        ))}
