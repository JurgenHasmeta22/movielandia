...
export default async function ActorPage(props: IActorProps) {
	...
	const starredMoviesPage = searchParams?.starredMoviesPage
		? Number(searchParams.starredMoviesPage)
		: 1;
	const starredSeriesPage = searchParams?.starredSeriesPage
		? Number(searchParams.starredSeriesPage)
		: 1;
