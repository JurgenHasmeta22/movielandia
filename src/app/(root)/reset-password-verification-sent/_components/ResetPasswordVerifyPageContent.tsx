...
export default function ResetPasswordVerifyPageContent({ email }: ResetPasswordVerifyPageContentProps) {
    if (!email) {
        return (
    ...
    return (
        <VerificationLayout title="Check Your Email">
            <Box sx={{ textAlign: "center" }}>
                <MarkEmailReadIcon sx={{ fontSize: 60, color: "primary.main", mb: 3 }} />
