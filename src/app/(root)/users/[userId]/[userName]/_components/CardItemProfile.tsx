			...
			switch (type) {
				case "Movies":
					await onRemoveBookmarkMovie(
						(favItem as FavoriteMovie).movie,
					);
					break;
				case "Series":
					await onRemoveBookmarkSerie(
						(favItem as FavoriteSerie).serie,
					);
					break;
				case "Actors":
					await onRemoveBookmarkActor(
						(favItem as FavoriteActor).actor,
					);
					break;
				case "Crew":
				...
				case "Seasons":
					await onRemoveBookmarkSeason(
						(favItem as FavoriteSeason).season,
					);
					break;
				case "Episodes":
					await onRemoveBookmarkEpisode(
						(favItem as FavoriteEpisode).episode,
					);
					break;
			}
		});
