        ...
        default: ({ children, ...props }: any) => {
            ...
            return (
                <div data-testid="slider-mock">
                    <div data-testid="slider-props" data-props={JSON.stringify(serializableProps)} />
...
const renderListHomeSection = (
    ...
    return render(
        <ThemeProvider theme={theme}>
            <ListHomeSection data={data} type={type} link={link} linkText={linkText} path={path} />
        </ThemeProvider>,
    );
};
...
describe("ListHomeSection Component", () => {
    ...
    it("renders the correct link text", () => {
        renderListHomeSection(mockMovies, "movie", "/movies", "View All Movies");
    ...
    it("passes the correct data to CardItem for series", () => {
        renderListHomeSection(mockSeries, "serie", "/series", "View All Series", "series");
        const cardItems = screen.getAllByTestId("card-item-mock");
