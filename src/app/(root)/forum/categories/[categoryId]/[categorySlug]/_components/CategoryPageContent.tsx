...
export default function CategoryPageContent({
	...
	const [_topicsPage, setTopicsPage] = useQueryState("topicsPage", {
		shallow: false,
	});
	const [_topicsSortBy, setTopicsSortBy] = useQueryState("topicsSortBy", {
		shallow: false,
	});
	const [_topicsAscOrDesc, setTopicsAscOrDesc] = useQueryState(
		"topicsAscOrDesc",
		{ shallow: false },
	);
