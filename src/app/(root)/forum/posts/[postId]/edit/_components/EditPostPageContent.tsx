...
import { Box, Container, Typography, Breadcrumbs, Link as MuiLink, Paper, Button, Alert } from "@mui/material";
...
export default function EditPostPageContent({ post, session }: IEditPostPageContentProps) {
