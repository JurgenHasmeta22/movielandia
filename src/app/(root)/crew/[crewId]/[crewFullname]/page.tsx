...
export default async function CrewPage(props: ICrewProps) {
	...
	const reviewsPage =
		searchParams && searchParams.reviewsPage
			? Number(searchParams.reviewsPage)
			: 1;
	const reviewsSortBy =
		searchParams && searchParams.reviewsSortBy
			? searchParams.reviewsSortBy
			: "";

	const producedMoviesPage = searchParams?.producedMoviesPage
		? Number(searchParams.producedMoviesPage)
		: 1;
	const producedSeriesPage = searchParams?.producedSeriesPage
		? Number(searchParams.producedSeriesPage)
		: 1;
