        ...
        <Stack spacing={6} alignItems="center" sx={{ mt: 6, py: 6 }}>
            ...
            >
                <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                    ...
                    <Box sx={{ mt: 4, textAlign: "center", width: { xs: 120, sm: 150 } }}>
                        <Skeleton variant="text" sx={{ width: "100%", height: 36 }} />
                        <Skeleton variant="text" sx={{ width: "100%", height: 28, mt: 1 }} />
                    </Box>
                </Box>
            ...
            <Box sx={{ width: "100%", maxWidth: 800, textAlign: "center", mb: 4 }}>
                <Skeleton variant="text" sx={{ width: "60%", height: 32, mb: 1 }} />
            ...
            <Box sx={{ width: "100%", maxWidth: 800, mb: 4 }}>
                ...
                <Stack direction="row" spacing={0} justifyContent="center">
                    {Array.from(new Array(6)).map((_, index) => (
                        <Skeleton key={index} variant="rectangular" sx={{ width: 100, height: 40 }} />
                    ))}
                </Stack>
                {/* Sub Tabs */}
                <Stack direction="row" spacing={0} justifyContent="center" sx={{ mt: 1 }}>
                    {Array.from(new Array(6)).map((_, index) => (
                        <Skeleton key={index} variant="rectangular" sx={{ width: 100, height: 40 }} />
                    ))}
                </Stack>
            ...
            <Box sx={{ width: "100%", maxWidth: 1200, px: { xs: 1, sm: 2 } }}>
                ...
                <Box sx={{ display: "flex", justifyContent: "center", mb: 4 }}>
                    <Skeleton variant="rectangular" sx={{ width: "40%", height: 48, borderRadius: 1 }} />
                </Box>
                {/* Grid of Content Cards Skeleton */}
                <Box
                    sx={{
                        display: "grid",
                        gridTemplateColumns: { xs: "repeat(auto-fill, minmax(125px, 1fr))", sm: "repeat(6, 125px)" },
                        gap: 2,
                ...
                >
                    {Array.from(new Array(6)).map((_, index) => (
                        <Skeleton key={index} variant="rectangular" sx={{ width: 125, height: 170 }} />
                    ))}
                </Box>
                {/* Pagination Skeleton */}
