...
// #region "Add Favorite"
export async function addFavoriteSerieToUser(
	userId: number,
	serieId: number,
): Promise<void> {
	try {
...
export async function addFavoriteMovieToUser(
	userId: number,
	movieId: number,
): Promise<void> {
	try {
...
export async function addFavoriteSeasonToUser(
	userId: number,
	seasonId: number,
): Promise<void> {
	try {
...
export async function addFavoriteEpisodeToUser(
	userId: number,
	episodeId: number,
): Promise<void> {
	try {
...
export async function addFavoriteActorToUser(
	userId: number,
	actorId: number,
): Promise<void> {
	try {
...
export async function addFavoriteCrewToUser(
	userId: number,
	crewId: number,
): Promise<void> {
	try {
...
export async function removeFavoriteMovieToUser(
	userId: number,
	movieId: number,
	pathFrom: string,
): Promise<void> {
...
export async function removeFavoriteSerieToUser(
	userId: number,
	serieId: number,
	pathFrom: string,
): Promise<void> {
...
export async function removeFavoriteSeasonToUser(
	userId: number,
	seasonId: number,
	pathFrom: string,
): Promise<void> {
...
export async function removeFavoriteEpisodeToUser(
	userId: number,
	episodeId: number,
	pathFrom: string,
): Promise<void> {
...
export async function removeFavoriteActorToUser(
	userId: number,
	actorId: number,
	pathFrom?: string,
): Promise<void> {
...
export async function removeFavoriteCrewToUser(
	userId: number,
	crewId: number,
	pathFrom?: string,
): Promise<void> {
