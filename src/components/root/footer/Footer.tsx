...
import { Box, Typography, Stack, Button, useTheme, Container, Paper } from "@mui/material";
                        ...
                        >
                            ...
                            <Box sx={{ mb: 3 }}>
                                <Typography variant="body2" sx={{ mb: 2, opacity: 0.9 }}>
                                    Subscribe to our newsletter for updates on new releases, features, and promotions.
                                </Typography>
                                <Stack direction="row" spacing={1}>
                                    ...
                                    >
                                        <EmailIcon sx={{ color: "rgba(255, 255, 255, 0.5)", mr: 1.5, flexShrink: 0 }} />
                                        <Box
                                            component="input"
                                            type="email"
                            ...
                            >
                                ...
                                <SocialButton href="https://youtube.com" icon={YouTubeIcon} />
                            </Stack>
                        </Paper>
                    </Box>
                </Box>

                <Box sx={{ width: "100%", height: "1px", backgroundColor: "rgba(255, 255, 255, 0.05)", my: 3 }} />
